      ...
      <div className="mx-auto max-w-6xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-gray-600">
            Simple tips to keep your skin, body, and eyes protected during hot
            summer days.
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-2xl bg-orange-50 p-6 shadow-sm">
            ...
            <p className="mt-3 text-gray-700">
              Drink enough water throughout the day to keep your body cool and
              refreshed.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-orange-50 p-6 shadow-sm">
            ...
            <p className="mt-3 text-gray-700">
              Protect your eyes with UV protection sunglasses during sunny
              summer outings.
            </p>
          </div>
        </div>
